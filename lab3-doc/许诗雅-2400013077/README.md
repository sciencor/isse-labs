...
我一开始尝试直接把所有想要调整的UI元素都写在prompt里，但是效果不是很理想。后面改为逐个逐个调整，并且把具体要实现的交互逻辑或style列点讲清楚，并用多轮对话微调，效果会更好，更新迭代更稳定。

但总归来说，真的能够0代码实现一个功能完善的TodoList系统，只是需要花费一定的时间和精力来调试和优化，神奇！